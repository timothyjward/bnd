...
JarFile in_build_pluginManagement_api_jar = new JarFile(api_bundle)
Attributes in_build_pluginManagement_api_manifest = api_jar.getManifest().getMainAttributes()
